...
public class ConsoleMenu {
    ...
    public void StandartConsoleMenu(){
        ...
        while (action != 0) {
            CommandResult<String> result = user.RunConnect( new String[]{"jdbc:sqlserver://localhost:1433;instance=DESKTOP-SN8BAOR;databaseName=MobileСompany;encrypt=true;trustServerCertificate=true",
                    "sa","12345678"});
